...
const aboutStoryEN = [
    ...
    "Throughout my academic journey and internship, I gained hands-on experience in data analytics, dashboard development, system testing, web development, and tools such as Power BI, Excel, MySQL, Python, HTML, CSS, and JavaScript. I also actively use AI tools such as ChatGPT, Claude, Google Gemini, NotebookLM, and other AI-powered tools to support my work, research, analysis, and development. I see AI not as a replacement for technical skills, but as a tool to enhance productivity, creativity, and the quality of my work. " ,
    ...
    "Outside of work, I enjoy playing badminton and Mobile Legends. I reached Mythical Glory as a Kagura main, which I believe has also taught me a little about strategy, teamwork, and staying calm under pressure. One small habit that reflects my personality is carrying mini packets of cat food in my bag so I can feed stray cats",
...
const aboutStoryMS = [
    ...
    "Di luar bidang kerja, saya gemar bermain badminton dan Mobile Legends. Saya pernah mencapai tahap Mythical Glory sebagai pemain Kagura, yang turut mengajar saya tentang strategi, kerja berpasukan dan kekal tenang ketika berada di bawah tekanan. Satu tabiat kecil yang mencerminkan keperibadian saya ialah membawa pek kecil makanan kucing di dalam beg supaya saya dapat memberi makan kepada kucing terbiar apabila terserempak dengannya.",
...
const aboutStoryJA = [
    ...
    "大学での学習およびインターンシップを通して、データ分析、ダッシュボード開発、システムテスト、Web開発などの実務経験を積みました。また、Power BI、Excel、MySQL、Python、HTML、CSS、JavaScriptなどの技術も使用してきました。さらに、ChatGPT、Claude、Google Gemini、NotebookLMなどのAIツールを積極的に活用し、業務、リサーチ、分析、開発などをサポートしています。私はAIを技術的なスキルの代替としてではなく、生産性、創造性、そして仕事の質を高めるためのツールとして捉えています。",
    ...
    "仕事以外では、バドミントンやMobile Legendsを楽しんでいます。Kaguraをメインキャラクターとしてプレイし、Mythical Gloryランクに到達しました。この経験を通して、戦略、チームワーク、そしてプレッシャーの中でも冷静に対応することの大切さを学びました。また、私らしさを表す小さな習慣として、バッグに小さな猫用フードを入れておき、野良猫を見かけた際には餌をあげるようにしています。",
