...
const translations = {
  en: {
    magic_message:
      "Welcome! Before you start exploring, feel free to press the music button and enjoy my favourite playlist while you look through my portfolio.",
    nav_home: "Home",
    nav_about: "About",
    nav_skills: "Skills",
    ...
    hero_tagline:
      "Aspiring full stack developer, curious about data and design.",
    ...
    about_tag1: "<i class='fa-solid fa-chart-column'></i> Power BI",
    about_tag2: "<i class='fa-solid fa-microchip'></i> AI Technology",
    about_tag3: "<i class='fa-solid fa-cat'></i> Cat Mom",
    about_tag4:
      "<i class='fa-solid fa-table-tennis-paddle-ball'></i> Badminton",
    about_tag5: "<i class='fa-solid fa-gamepad'></i> Glory Rank MLBB",
    about_tag6: "<i class='fa-solid fa-microphone'></i> Singing",
    ml_hero_caption:
      "Main Hero: Kagura — strategy, patience, and a touch of creativity",
    skills_heading: "Skills",
    education_heading: "Education",
    edu0_title:
      "Korea-ASEAN Digital Academy (KADA) Cohort II - AI Enabled Full Stack Development Bootcamp",
    edu0_sub:
      "Partners: AKCF · NIPA · UiTM · MDEC · Garranto Academy · ABLEARN",
    edu1_title:
      "Bachelor of Science (Hons.) Mathematical Modelling and Analytics",
    ...
    exp1_title: "Apprentice",
    exp1_sub:
      "K-Youth Development Programme — Khazanah Nasional x Aisling Group",
    exp2_title: "Data Analyst Intern",
    exp2_sub: "Unijaya Resources Sdn Bhd",
    exp3_title: "Printing Service Owner",
    exp3_sub: "Kolej Mawar, UiTM Shah Alam",
    exp4_title: "Mathematics & Science Tutor (Part-Time) ",
    exp4_sub: "Tuisyen Mesra PPR Lembah Subang 2",
    exp5_title: "Banquet Food Server (Part-Time)",
    exp5_sub: "Malaysia International Trade and Exhibition Centre (MITEC)",
    languages_heading: "Languages",
    volunteering_heading: "Volunteering",
    vol1_title:
      "<i class='fa-solid fa-people-group'></i> Festival Altruisme 3.0",
    vol1_desc:
      "Assisted in organizing a university festival centered on altruism and community engagement — supported event logistics, coordinated program activities, and assisted participants.",
    vol2_title:
      "<i class='fa-solid fa-flag-checkered'></i> Petronas GPM Grand Prix 2023",
    vol2_desc:
      "Volunteered as a UiTM representative at national motorsport events, supporting event activities and promoting student engagement.",
    vol3_title:
      "<i class='fa-solid fa-graduation-cap'></i> UiTM Convocation Ceremony",
    vol3_desc:
      "Assisted in managing event operations during graduation ceremonies, coordinating logistics and supporting graduates and guests.",
    vol4_title: "<i class='fa-solid fa-seedling'></i> Hari Komuniti MyPLUS",
    vol4_desc:
      "Contributed to school-led community clean-up initiatives, encouraging teamwork and community responsibility.",
    vol5_title: "<i class='fa-solid fa-heart'></i> Mawar Charity Fun Day",
    vol5_desc:
      "Planned and coordinated activities with orphans at Rumah Amal Budi Bistari, Shah Alam — interactive games, batik weaving sessions, and charity contributions.",
    vol6_title:
      "<i class='fa-solid fa-radiation'></i> PUSPATI TRIGA Reactor Tour",
    vol6_desc:
      "Gained exposure to nuclear reactor operations, safety protocols, and research applications in energy and science.",
    vol7_title:
      "<i class='fa-solid fa-book-open'></i> Selangor State-Level Language and Literature Festival",
    vol7_desc:
      "Supported the organisation and smooth execution of language and literature activities while assisting participants and promoting appreciation of Malay language and literature.",
    projects_heading: "Projects",
    projects_intro:
      "Hover a card to flip it and see the tools & story behind each one.",
    proj1_front_title: "Final Year Project",
    proj1_front_sub: "Hybrid Nanofluid Flow Modelling",
    proj1_back_title: "Mixed Convection Flow of Hybrid Nanofluids",
    proj1_back_desc:
      "Developed the mathematical model for mixed convection behavior of hybrid nanofluids flowing toward a stagnation point on a stretching cylinder with Newtonian heating effects.",
    proj2_front_title: "Economic Forecasting",
    proj2_front_sub: "US Policy Uncertainty Index",
    proj2_back_title: "Forecasting the U.S. EPU Index",
    proj2_back_desc:
      "Conducted time series forecasting on the U.S. Economic Policy Uncertainty Index, providing insights that support aviation industry decisions on capacity planning and strategy.",
    proj3_front_title: "Used Bike Market Insights",
    proj3_front_sub: "India Decision Support System",
    proj3_back_title: "Used Bike Market Decision Support",
    proj3_back_desc:
      "Developed an interactive Power BI decision support dashboard to analyze used bike market trends, pricing factors, and ownership patterns, enabling data-driven decisions for price optimization, inventory planning, and market trend analysis.",
    overview_btn: "<i class='fa-solid fa-magnifying-glass'></i> Overview",
    internship_heading: "Internship Projects",
    acc1_header:
      "<i class='fa-solid fa-desktop'></i> IRIS — Sistem Pengambilan Bersepadu (SPA Malaysia)",
    acc1_li1:
      "Conducted system testing for key modules, identifying defects and ensuring system functionality met business and user requirements.",
    acc1_li2:
      "Supported Final Acceptance Testing (FAT) by using Bluedot AI to capture meeting minutes, ensuring all feedback, decisions, and action items were accurately documented.",
    acc1_li3:
      "Used NotebookLM (Google AI) to quickly understand system workflows, improving testing speed and collaboration with team members.",
    acc1_li4:
      "Managed a centralized Google Sheets defect tracker to log issues, monitor testing progress, and follow up on bug fixes with developers.",
    acc2_header:
      "<i class='fa-solid fa-chart-column'></i> NSFiRM — National Suicide and Fatal Injury Registry (MOH Malaysia)",
    acc2_li1:
    ...
    acc2_li3:
      "Published and managed Power BI embed links for system integration and reporting updates using Google Sheets.",
    acc2_li4:
      "Worked with Navicat to explore the NSFiRM database structure, tables, relationships, and data flow.",
    acc3_header: "<i class='fa-solid fa-globe'></i> AI Translation Tool",
    acc3_li1:
      "Assisted in developing an AI-powered translation workflow using the Google Gemini API in Laravel to automate multilingual localization through both UI and CLI.",
    acc3_li2:
    ...
    dashboard_label:
      "<i class='fa-solid fa-chart-column'></i> Dashboard Preview",
    ...
    nsfirm_slide_label:
      "<i class='fa-solid fa-chart-column'></i> Dashboard Previews",
    ...
    ai_slide_label:
      "<i class='fa-solid fa-screwdriver-wrench'></i> Tool Preview",
    vision_heading: "Vision Board",
    vision_quote: '"My best version is still becoming."',
    vc_dress_title: "Dress well",
    vc_dress_desc: "Dress with elegance and carry myself with confidence.",
    vc_health_title: "Healthy lifestyle",
    vc_health_desc:
      "Eat well, stay active, and take care of my mind, body and soul.",
    vc_brand_title: "Side business / Own brand",
    vc_brand_desc:
      "Build my own brand, inspire more women, and create timeless pieces that empower — Jelita Aurelle, where elegance meets confidence.",
    vc_digital_title: "Master more digital skills",
    vc_digital_desc:
      "Level up my skills in data, analytics, design and tech to stay future-ready.",
    vc_community_title: "Community project",
    vc_community_desc:
      "Give back, make an impact, and be part of something meaningful.",
    vc_comm_title: "Confident communication skills",
    vc_comm_desc:
      "Speak with clarity, confidence and impact in every situation.",
    vc_cook_title: "Strengthen My Faith (Istiqamah)",
    vc_cook_desc:
      "Strive to become a better Muslim through istiqamah — pray on time, choose kind words, help those in need, and make Selawat Al-Fatih part of my daily routine.",
    vc_car_title: "Own car",
    vc_car_desc: "Financial freedom to own my car and go anywhere I want.",
    vc_umrah_title: "Family Umrah",
    vc_umrah_desc:
      "Travel together, pray together, and create beautiful memories.",
    vc_lang_title: "Learn new languages",
    vc_lang_desc:
      "Hangul & Mandarin — new language, new world, new opportunities.",
    vision_banner:
      "FAITH &nbsp;•&nbsp; FOCUS &nbsp;•&nbsp; CONSISTENCY &nbsp;•&nbsp; GRATITUDE = MY FUTURE",
    brand_title: "Jerelle — Jelita Aurelle",
    brand_tagline: "Elegance Meets Confidence",
    brand_desc:
      "A future own-brand for baju kurung, kebaya & modern tradisi — designing timeless, modest pieces that celebrate heritage while empowering today's confident woman.",
    brand_tag1: "Own Brand",
    brand_tag2: "Timeless Design",
    brand_tag3: "Empowering Women",
    ...
    cert10_title: "Kangaroo Math Competition - Bronze Medal",
    cert11_title: "SULAM Carnival",
    ...
    proj4_back_desc:
      "Developed a hotel reservation management system using Microsoft Access, applying relational database design, SQL, forms, and reports to streamline reservation processes and improve data management.",
    ...
    rooma_slide_label:
      "<i class='fa-solid fa-file-lines'></i> Full Project Report",
    acc2_li5:
      "Utilized ChatGPT and Claude AI to accelerate the development of advanced DAX and Power Query (M) solutions, enhancing dashboard functionality, performance, and user experience in Power BI.",
    acc3_li4:
      "Leveraged Claude AI to deepen understanding of Laravel development and Laragon environment configuration, troubleshoot implementation challenges, optimize code quality, and apply software engineering best practices.",
  },
  ms: {
    magic_message:
      "Selamat datang! Sebelum anda mula meneroka, anda boleh menekan butang muzik dan menikmati senarai lagu kegemaran saya sambil menelusuri portfolio ini.",
    nav_home: "Utama",
    nav_about: "Tentang",
    ...
    nav_projects: "Projek",
    nav_volunteering: "Kesukarelawanan",
    nav_vision: "Papan Visi",
    nav_contact: "Hubungi",
    hero_greeting: "Salam, saya",
    hero_tagline: "Bakal pembangun full stack, meminati data dan reka bentuk.",
    hero_btn_projects: "Projek Saya",
    hero_btn_contact: "Hubungi Saya",
    about_heading: "Tentang saya",
    about_intro:
      "Klik di bawah untuk mengetahui lebih lanjut tentang latar belakang dan perjalanan saya.",
    about_btn:
      "<i class='fa-solid fa-heart'></i> Ketahui Lebih Lanjut Tentang Putely",
    about_modal_title: "Selamat Datang ke Portfolio Saya",
    about_tag1: "<i class='fa-solid fa-chart-column'></i> Power BI",
    about_tag2: "<i class='fa-solid fa-microchip'></i> Teknologi AI",
    about_tag3: "<i class='fa-solid fa-cat'></i> Ibu Kucing",
    about_tag4:
      "<i class='fa-solid fa-table-tennis-paddle-ball'></i> Badminton",
    about_tag5: "<i class='fa-solid fa-gamepad'></i> Rank Glory MLBB",
    about_tag6: "<i class='fa-solid fa-microphone'></i> Menyanyi",
    ml_hero_caption:
      "Hero Utama: Kagura — strategi, kesabaran, dan sedikit kreativiti",
    skills_heading: "Kemahiran",
    education_heading: "Pendidikan",
    edu0_title:
      "Akademi Digital Korea-ASEAN (KADA) Kohort II - Kem Bootcamp Pembangunan Full Stack Berasaskan AI",
    edu0_sub:
      "Partners: AKCF · NIPA · UiTM · MDEC · Garranto Academy · ABLEARN",
    edu1_title:
      "Ijazah Sarjana Muda Sains (Kepujian) Pemodelan Matematik dan Analitik",
    ...
    exp1_title: "Perantis",
    exp1_sub: "Program Pembangunan K-Youth — Khazanah Nasional x Aisling Group",
    exp2_title: "Intern Penganalisis Data",
    exp2_sub: "Unijaya Resources Sdn Bhd",
    exp3_title: "Pemilik Perkhidmatan Percetakan",
    exp3_sub: "Kolej Mawar, UiTM Shah Alam",
    exp4_title: "Tutor Matematik & Sains (Sambilan)",
    exp4_sub: "Tuisyen Mesra PPR Lembah Subang 2",
    exp5_title: "Pelayan Majlis Jamuan (Sambilan)",
    exp5_sub: "Pusat Dagangan Antarabangsa Malaysia (MITEC)",
    languages_heading: "Bahasa",
    volunteering_heading: "Kesukarelawanan",
    vol1_title:
      "<i class='fa-solid fa-people-group'></i> Festival Altruisme 3.0",
    vol1_desc:
      "Membantu mengelolakan festival universiti berkonsepkan altruisme dan penglibatan komuniti — menyokong logistik acara, menyelaraskan aktiviti program, dan membantu peserta.",
    vol2_title:
      "<i class='fa-solid fa-flag-checkered'></i> Petronas GPM Grand Prix 2023",
    vol2_desc:
      "Menjadi sukarelawan sebagai wakil UiTM di acara sukan motor peringkat kebangsaan, menyokong aktiviti acara dan menggalakkan penglibatan pelajar.",
    vol3_title:
      "<i class='fa-solid fa-graduation-cap'></i> Majlis Konvokesyen UiTM",
    vol3_desc:
      "Membantu menguruskan operasi acara semasa majlis konvokesyen, menyelaraskan logistik dan menyokong graduan serta tetamu.",
    vol4_title: "<i class='fa-solid fa-seedling'></i> Hari Komuniti MyPLUS",
    vol4_desc:
      "Menyumbang kepada inisiatif gotong-royong komuniti anjuran sekolah, menggalakkan kerja berpasukan dan tanggungjawab komuniti.",
    vol5_title: "<i class='fa-solid fa-heart'></i> Mawar Charity Fun Day",
    vol5_desc:
      "Merancang dan menyelaraskan aktiviti bersama anak yatim di Rumah Amal Budi Bistari, Shah Alam — permainan interaktif, sesi menganyam batik, dan sumbangan amal.",
    vol6_title:
      "<i class='fa-solid fa-radiation'></i> Lawatan Reaktor PUSPATI TRIGA",
    vol6_desc:
      "Mendapat pendedahan mengenai operasi reaktor nuklear, protokol keselamatan, dan aplikasi penyelidikan dalam bidang tenaga dan sains.",
    vol7_title:
      "<i class='fa-solid fa-book-open'></i> Festival Bahasa dan Sastera Peringkat Selangor",
    vol7_desc:
      "Menyokong penganjuran dan pelaksanaan aktiviti bahasa dan sastera dengan lancar, di samping membantu peserta serta memupuk penghargaan terhadap bahasa dan sastera Melayu.",
    projects_heading: "Projek",
    projects_intro:
      "Hover kad untuk membalikkannya dan lihat alat & kisah di sebaliknya.",
    proj1_front_title: "Projek Tahun Akhir",
    proj1_front_sub: "Pemodelan Aliran Nanofluid Hibrid",
    proj1_back_title: "Aliran Konveksi Campuran Nanofluid Hibrid",
    proj1_back_desc:
      "Membangunkan model matematik untuk kelakuan konveksi campuran nanofluid hibrid yang mengalir ke titik genangan pada silinder yang meregang dengan kesan pemanasan Newtonian.",
    proj2_front_title: "Ramalan Ekonomi",
    proj2_front_sub: "Indeks Ketidaktentuan Dasar AS",
    proj2_back_title: "Meramal Indeks EPU Amerika Syarikat",
    proj2_back_desc:
      "Menjalankan ramalan siri masa ke atas Indeks Ketidaktentuan Dasar Ekonomi AS, memberikan input yang menyokong keputusan industri penerbangan mengenai perancangan kapasiti dan strategi.",
    proj3_front_title: "Wawasan Pasaran Motosikal Terpakai",
    proj3_front_sub: "Sistem Sokongan Keputusan India",
    proj3_back_title: "Sokongan Keputusan Pasaran Motosikal Terpakai",
    proj3_back_desc:
      "Membangunkan dashboard sokongan keputusan Power BI interaktif untuk menganalisis trend pasaran motosikal terpakai, faktor harga, dan corak pemilikan, membolehkan keputusan berasaskan data untuk pengoptimuman harga, perancangan inventori, dan analisis trend pasaran.",
    overview_btn: "<i class='fa-solid fa-magnifying-glass'></i> Gambaran",
    internship_heading: "Projek Latihan Industri",
    acc1_header:
      "<i class='fa-solid fa-desktop'></i> IRIS — Sistem Pengambilan Bersepadu (SPA Malaysia)",
    acc1_li1:
      "Melaksanakan ujian sistem untuk modul utama, mengenal pasti kecacatan (defects) dan memastikan fungsi sistem memenuhi keperluan perniagaan serta pengguna.",
    acc1_li2:
      "Menyokong Final Acceptance Testing (FAT) dengan menggunakan Bluedot AI untuk merekod minit mesyuarat, memastikan semua maklum balas, keputusan, dan tindakan susulan didokumentasikan dengan tepat.",
    acc1_li3:
      "Menggunakan NotebookLM (Google AI) untuk memahami aliran sistem dengan lebih cepat, meningkatkan kelajuan ujian serta kerjasama dengan ahli pasukan.",
    acc1_li4:
      "Menguruskan penjejak kecacatan berpusat menggunakan Google Sheets untuk merekod isu, memantau kemajuan ujian, dan membuat susulan pembetulan pepijat bersama pembangun sistem",
    acc2_header:
      "<i class='fa-solid fa-chart-column'></i> NSFiRM — Daftar Bunuh Diri dan Kecederaan Maut Kebangsaan (KKM Malaysia)",
    acc2_li1:
    ...
    acc2_li3:
      "Menerbit dan menguruskan pautan embed Power BI untuk integrasi sistem dan kemas kini laporan menggunakan Google Sheets.",
    acc2_li4:
      "Bekerja dengan Navicat untuk meneroka struktur pangkalan data NSFiRM, jadual, hubungan, dan aliran data.",
    acc3_header: "<i class='fa-solid fa-globe'></i> Alat Terjemahan AI",
    acc3_li1:
      "Membangunkan aliran kerja terjemahan berkuasa AI menggunakan Google Gemini API dalam Laravel untuk mengautomasikan penyetempatan pelbagai bahasa melalui UI dan CLI",
    acc3_li2:
    ...
    dashboard_label:
      "<i class='fa-solid fa-chart-column'></i> Paparan Dashboard",
    ...
    ai_slide_label:
      "<i class='fa-solid fa-screwdriver-wrench'></i> Slaid Projek",
    vision_heading: "Papan Visi",
    vision_quote: '"Versi terbaik saya masih dalam proses."',
    vc_dress_title: "Berpakaian kemas",
    vc_dress_desc: "Berpakaian anggun dan membawa diri dengan penuh keyakinan.",
    vc_health_title: "Gaya hidup sihat",
    vc_health_desc:
      "Makan dengan baik, kekal aktif, dan menjaga minda, tubuh dan jiwa.",
    vc_brand_title: "Perniagaan sampingan / Jenama sendiri",
    vc_brand_desc:
      "Membina jenama sendiri, memberi inspirasi kepada lebih ramai wanita, dan mencipta koleksi abadi yang memperkasa — Jelita Aurelle, di mana keanggunan bertemu keyakinan.",
    vc_digital_title: "Menguasai lebih kemahiran digital",
    vc_digital_desc:
      "Meningkatkan kemahiran dalam data, analitik, reka bentuk dan teknologi untuk terus relevan.",
    vc_community_title: "Projek komuniti",
    vc_community_desc:
      "Memberi kembali, memberi impak, dan menjadi sebahagian daripada sesuatu yang bermakna.",
    vc_comm_title: "Kemahiran komunikasi yakin",
    vc_comm_desc:
      "Bercakap dengan jelas, yakin dan berkesan dalam setiap situasi.",
    vc_cook_title: "Memperkukuh Iman (Istiqamah)",
    vc_cook_desc:
      "Berusaha menjadi seorang Muslim yang lebih baik melalui istiqamah — solat tepat pada waktunya, bertutur dengan kata-kata yang baik, membantu mereka yang memerlukan, serta menjadikan Selawat Al-Fatih sebahagian daripada rutin harian saya.",
    vc_car_title: "Memiliki kereta sendiri",
    vc_car_desc:
      "Kebebasan kewangan untuk memiliki kereta sendiri dan pergi ke mana sahaja.",
    vc_umrah_title: "Umrah bersama keluarga",
    vc_umrah_desc:
      "Bermusafir bersama, bersolat bersama, dan mencipta kenangan indah.",
    vc_lang_title: "Belajar bahasa baharu",
    vc_lang_desc:
      "Hangul & Mandarin — bahasa baharu, dunia baharu, peluang baharu.",
    vision_banner:
      "IMAN &nbsp;•&nbsp; FOKUS &nbsp;•&nbsp; KONSISTENSI &nbsp;•&nbsp; KESYUKURAN = MASA DEPAN SAYA",
    brand_title: "Jerelle — Jelita Aurelle",
    brand_tagline: "Keanggunan Bertemu Keyakinan",
    brand_desc:
      "Bakal jenama sendiri untuk baju kurung, kebaya & moden tradisi — mereka bentuk pakaian sopan yang abadi, meraikan warisan sambil memperkasakan wanita yakin hari ini.",
    brand_tag1: "Jenama Sendiri",
    brand_tag2: "Reka Bentuk Abadi",
    brand_tag3: "Memperkasa Wanita",
    contact_heading: "Hubungi",
    lightbox_hint: "Klik di luar untuk tutup",
    nav_licenses: "Lesen",
    licenses_heading: "Lesen &amp; Pensijilan",
    licenses_intro:
      'Pilih "Lihat Sijil" pada mana-mana kad untuk paparan lebih dekat.',
    ...
    cert10_title: "Pertandingan Matematik Kangaroo - Pingat Gangsa",
    cert11_title: "Karnival SULAM",
    cert13_title: "Sijil SUKOL - Mobile Legends: Bang Bang",
    cert14_title: "Sijil Sukarelawan Hari Komuniti PLUS",
    cert15_title: "Sijil Sukarelawan Eksplorasi Bahasa",
    ...
    proj4_back_desc:
      "Membangunkan sistem pengurusan tempahan hotel menggunakan Microsoft Access, mengaplikasikan reka bentuk pangkalan data hubungan, SQL, borang, dan laporan untuk memperkemas proses tempahan serta meningkatkan pengurusan data.",
    ...
    rooma_slide_label:
      "<i class='fa-solid fa-file-lines'></i> Laporan Penuh Projek",
    acc2_li5:
      "Menggunakan ChatGPT dan Claude AI untuk mempercepatkan pembangunan penyelesaian DAX dan Power Query (M) yang lebih kompleks, meningkatkan fungsi, prestasi, dan pengalaman pengguna dashboard dalam Power BI.",
    acc3_li4:
      "Menggunakan Claude AI untuk memperdalam pemahaman mengenai pembangunan Laravel dan konfigurasi persekitaran Laragon, menyelesaikan cabaran pelaksanaan, mengoptimumkan kualiti kod, dan mengaplikasikan amalan terbaik kejuruteraan perisian.",
  },
  ja: {
    magic_message:
      "ようこそ！探索を始める前に、音楽ボタンを押して私のお気に入りの曲を聴きながら、このポートフォリオをご覧ください。",
    nav_home: "ホーム",
    nav_about: "About",
    nav_skills: "スキル",
    nav_education: "学歴",
    nav_experience: "職歴",
    nav_projects: "プロジェクト",
    nav_volunteering: "ボランティア",
    nav_vision: "ビジョンボード",
    nav_contact: "お問い合わせ",
    hero_greeting: "こんにちは、",
    hero_tagline:
      "データとデザインに情熱を注ぐ、フルスタック開発者を目指しています。",
    hero_btn_projects: "プロジェクトを見る",
    hero_btn_contact: "お問い合わせ",
    about_heading: "自己紹介",
    about_intro:
      "詳しいプロフィールをご覧いただくには、下のボタンをクリックしてください。",
    about_btn: "<i class='fa-solid fa-heart'></i> Putelyについて詳しく見る",
    about_modal_title: "ようこそ、私のポートフォリオへ",
    about_tag1: "<i class='fa-solid fa-chart-column'></i> Power BI",
    about_tag2: "<i class='fa-solid fa-microchip'></i> AI技術",
    about_tag3: "<i class='fa-solid fa-cat'></i> 猫のママ",
    about_tag4:
      "<i class='fa-solid fa-table-tennis-paddle-ball'></i> バドミントン",
    about_tag5: "<i class='fa-solid fa-gamepad'></i> MLBB グローリーランク",
    about_tag6: "<i class='fa-solid fa-microphone'></i> 歌うこと",
    ml_hero_caption: "推しヒーロー：カグラ — 戦略、忍耐、そして少しのカオス",
    skills_heading: "スキル",
    education_heading: "学歴",
    edu0_title:
      "韓国・ASEANデジタルアカデミー（KADA）第II期 - AI対応フルスタック開発ブートキャンプ",
    edu0_sub:
      "Partners: AKCF · NIPA · UiTM · MDEC · Garranto Academy · ABLEARN",
    ...
    exp1_sub:
      "K-Youth Development Programme — Khazanah Nasional x Aisling Group",
    exp2_title: "データアナリストインターン",
    exp2_sub: "Unijaya Resources Sdn Bhd",
    exp3_title: "印刷サービスオーナー",
    exp3_sub: "Kolej Mawar, UiTM Shah Alam",
    exp4_title: "数学・理科チューター（アルバイト）",
    exp4_sub: "Tuisyen Mesra PPR Lembah Subang 2",
    exp5_title: "宴会フードサーバー（アルバイト）",
    exp5_sub: "マレーシア国際貿易展示センター（MITEC）",
    languages_heading: "言語",
    volunteering_heading: "ボランティア",
    vol1_title:
      "<i class='fa-solid fa-people-group'></i> Festival Altruisme 3.0",
    vol1_desc:
      "利他主義と地域交流をテーマにした大学フェスティバルの運営を支援 — イベントのロジスティクス、プログラム進行、参加者サポートを担当。",
    vol2_title:
      "<i class='fa-solid fa-flag-checkered'></i> ペトロナスGPMグランプリ 2023",
    vol2_desc:
      "UiTM代表として国内モータースポーツイベントでボランティア活動を行い、学生の参加を促進。",
    vol3_title: "<i class='fa-solid fa-graduation-cap'></i> UiTM卒業式典",
    vol3_desc:
      "卒業式典の運営を支援し、ロジスティクスの調整や卒業生・来賓のサポートを担当。",
    vol4_title: "<i class='fa-solid fa-seedling'></i> Hari Komuniti MyPLUS",
    vol4_desc:
      "学校主導の地域清掃活動に貢献し、チームワークと地域責任感を促進。",
    vol5_title:
      "<i class='fa-solid fa-heart'></i> Mawarチャリティー・ファンデー",
    vol5_desc:
      "Rumah Amal Budi Bistari（シャー・アラム）の孤児たちとの活動を企画・運営 — インタラクティブなゲーム、バティック織り体験、チャリティー活動。",
    vol6_title: "<i class='fa-solid fa-radiation'></i> PUSPATI TRIGA原子炉見学",
    vol6_desc:
      "原子炉の運転、安全プロトコル、エネルギー・科学分野での研究応用について学ぶ機会を得る。",
    vol7_title:
      "<i class='fa-solid fa-book-open'></i> セランゴール州言語・文学祭",
    vol7_desc:
      "言語・文学活動の企画および円滑な実施を支援するとともに、参加者をサポートし、マレー語とマレー文学への理解と関心を促進しました。",
    projects_heading: "プロジェクト",
    projects_intro:
      "カードにカーソルを合わせると裏返り、使用ツールとストーリーが見られます。",
    proj1_front_title: "卒業研究プロジェクト",
    proj1_front_sub: "ハイブリッドナノ流体流れのモデリング",
    proj1_back_title: "ハイブリッドナノ流体の混合対流",
    proj1_back_desc:
      "ニュートン加熱の影響下で、伸縮する円柱上のよどみ点に向かうハイブリッドナノ流体の混合対流挙動の数理モデルを開発しました。",
    proj2_front_title: "経済予測",
    proj2_front_sub: "米国政策不確実性指数",
    proj2_back_title: "米国EPU指数の予測",
    proj2_back_desc:
      "米国経済政策不確実性指数の時系列予測を行い、航空業界の容量計画・戦略に関する意思決定を支援する知見を提供しました。",
    proj3_front_title: "中古バイク市場インサイト",
    proj3_front_sub: "インド意思決定支援システム",
    proj3_back_title: "中古バイク市場の意思決定支援",
    proj3_back_desc:
      "中古バイク市場のトレンド、価格要因、所有パターンを分析するインタラクティブなPower BI意思決定支援ダッシュボードを開発し、価格最適化・在庫計画・市場トレンド分析のデータドリブンな意思決定を可能にしました。",
    overview_btn: "<i class='fa-solid fa-magnifying-glass'></i> 概要",
    internship_heading: "インターンシッププロジェクト",
    acc1_header:
      "<i class='fa-solid fa-desktop'></i> IRIS — 統合採用システム（マレーシアSPA）",
    acc1_li1:
      "主要モジュールのシステムテストを実施し、不具合を特定するとともに、システム機能が業務およびユーザー要件を満たしていることを確認しました。",
    acc1_li2:
      "Final Acceptance Testing（FAT）を支援し、Bluedot AIを使用して議事録を作成し、すべてのフィードバック、決定事項、アクションアイテムが正確に記録されるようにしました。",
    acc1_li3:
      "NotebookLM（Google AI）を活用してシステムのワークフローを迅速に理解し、テストの効率向上およびチームメンバーとの連携強化に貢献しました。",
    acc1_li4:
      "Google Sheetsを用いて一元化された不具合管理トラッカーを管理し、問題の記録、テスト進捗の監視、および開発者とのバグ修正のフォローアップを行いました。",
    acc2_header:
      "<i class='fa-solid fa-chart-column'></i> NSFiRM — 国家自殺・致死傷害登録システム（マレーシア保健省）",
    acc2_li1:
      "Power BIでのNSFiRMダッシュボードの開発・改善を支援（DAXメジャー、マップ可視化、インタラクティブなレポート機能を含む）。",
    acc2_li2: "国及び州レベルでダッシュボードのロジックをテスト",
    acc2_li3:
      "システム統合およびレポート更新のため、Google Sheetsを活用しPower BI埋め込みリンクの公開・管理を実施",
    acc2_li4:
      "NavicatでNSFiRMデータベースの構造、テーブル、関連性、データフローを調査",
    acc3_header: "<i class='fa-solid fa-globe'></i> AI翻訳ツール",
    acc3_li1:
      "LaravelでGoogle Gemini APIを使用したAI駆動の翻訳ワークフローを開発し、UIとCLI経由で多言語ローカライゼーションを自動化",
    acc3_li2:
      "Figma AIとVuexyコンポーネントを用いたAI支援UI/UXデザインを調査・適用し、インターフェースデザインを効率化",
    acc3_li3:
      "ツールの目的、ワークフロー、利点に関する技術プレゼンテーションを準備・発表",
    ...
    slide_label:
      "<i class='fa-solid fa-file-lines'></i> プロジェクト全体報告書",
    slide_label1: "<i class='fa-solid fa-file-lines'></i> プロジェクトスライド",
    dashboard_label:
      "<i class='fa-solid fa-chart-column'></i> ダッシュボードプレビュー",
    ...
    ai_slide_label:
      "<i class='fa-solid fa-screwdriver-wrench'></i> ツールプレビュー",
    vision_heading: "ビジョンボード",
    vision_quote: "「最高の自分は、まだ完成していない。」",
    vc_dress_title: "身だしなみを整える",
    vc_dress_desc: "上品に装い、自信を持って振る舞う。",
    vc_health_title: "健康的な生活",
    vc_health_desc: "きちんと食べ、活動的でいて、心と体と魂を大切にする。",
    vc_brand_title: "副業・自社ブランド",
    vc_brand_desc:
      "自分のブランドを築き、多くの女性にインスピレーションを与え、時代を超えるアイテムを生み出す — エレガンスと自信が出会うJelita Aurelle。",
    vc_digital_title: "デジタルスキルをさらに磨く",
    vc_digital_desc:
      "データ、分析、デザイン、テクノロジーのスキルを高め、常に将来に備える。",
    vc_community_title: "地域貢献プロジェクト",
    vc_community_desc:
      "恩返しをし、良い影響を与え、意義のあることの一部になる。",
    vc_comm_title: "自信あるコミュニケーション能力",
    vc_comm_desc: "あらゆる場面で明確に、自信を持って、効果的に話す。",
    vc_cook_title: "信仰を深める（イスティカーマ）",
    vc_cook_desc:
      "定刻の礼拝、思いやりのある言葉づかい、困っている方への支援、そしてサラワート・アル＝ファーティフを日々の習慣に取り入れることを通じて、より良いムスリムであることを目指しています。",
    vc_car_title: "自分の車を持つ",
    vc_car_desc: "経済的自由を得て自分の車を持ち、どこへでも行く。",
    vc_umrah_title: "家族でウムラ巡礼",
    vc_umrah_desc: "共に旅し、共に祈り、美しい思い出を作る。",
    vc_lang_title: "新しい言語を学ぶ",
    vc_lang_desc: "ハングルと中国語 — 新しい言語、新しい世界、新しいチャンス。",
    vision_banner:
      "信念 &nbsp;•&nbsp; 集中 &nbsp;•&nbsp; 継続 &nbsp;•&nbsp; 感謝 = 私の未来",
    brand_title: "Jerelle — Jelita Aurelle",
    brand_tagline: "エレガンスと自信の融合",
    brand_desc:
      "バジュ・クロン、クバヤ、モダン・トラディシのための将来の自社ブランド構想 — 伝統を称えながら、現代の自信ある女性を後押しする、上品で控えめなデザインを目指します。",
    brand_tag1: "自社ブランド",
    brand_tag2: "時代を超えるデザイン",
    brand_tag3: "女性のエンパワーメント",
    contact_heading: "お問い合わせ",
    lightbox_hint: "外側をクリックして閉じる",
    nav_licenses: "ライセンス",
    licenses_heading: "ライセンスと認定資格",
    licenses_intro:
      "各カードの「証明書を見る」を選択すると、詳細をご覧いただけます。",
    ...
    cert10_title: "カンガルー数学コンペティション - 銅メダル",
    cert11_title: "SULAMカーニバル",
    cert13_title: "SUKOL証明書 - Mobile Legends: Bang Bang",
    cert14_title: "Hari Komuniti PLUS ボランティア証明書",
    cert15_title: "Eksplorasi Bahasa ボランティア証明書",
    ...
    proj4_back_desc:
      "Microsoft Accessを用いてホテル予約管理システムを開発。リレーショナルデータベース設計、SQL、フォーム、レポートを活用し、予約業務の効率化とデータ管理の向上を実現した。",
    ...
    rooma_slide_label:
      "<i class='fa-solid fa-file-lines'></i> プロジェクト全体報告書",
    acc2_li5:
      "ChatGPTおよびClaude AIを活用し、高度なDAXおよびPower Query（M）ソリューションの開発を加速させ、Power BIにおけるダッシュボードの機能性、パフォーマンス、ユーザー体験を向上させた。",
    acc3_li4:
      "Claude AIを活用してLaravel開発およびLaragon環境設定への理解を深め、実装上の課題を解決し、コード品質を最適化するとともに、ソフトウェア工学のベストプラクティスを適用した。",
  },
};
...
function applyLanguage(lang) {
  ...
  try {
    localStorage.setItem("putely-lang", lang);
  } catch (e) {}
}
...
window.addEventListener("DOMContentLoaded", () => {
  let savedLang = "en";
  try {
    savedLang = localStorage.getItem("putely-lang") || "en";
  } catch (e) {}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function setTheme(isDark) {
    ...
    try {
      localStorage.setItem("putely-theme", isDark ? "dark" : "light");
    } catch (e) {}
  }

  let savedTheme = "light";
  try {
    savedTheme = localStorage.getItem("putely-theme") || "light";
  } catch (e) {}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const galleries = {
    fyp: {
      files: buildNumbered("images/myfyp_slides/", "slide-", 31).filter(
        (_, index) => index !== 1,
      ),
      img: "fypSlideImg",
      counter: "fypCounter",
    ...
    nsfirm: {
      files: [
        "images/PSN_dashboard_prev.jpg",
        "images/FIN_dashboard_prev.jpg",
        "images/CRN_dashboard_prev.jpg",
      ],
      img: "nsfirmSlideImg",
      counter: "nsfirmCounter",
      current: 0,
    },
    ai: {
  ...
  document.querySelectorAll(".slide-nav").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      if (btn.classList.contains("next")) goNext(key);
      else goPrev(key);
    });
  });
  ...
  document.addEventListener("keydown", (e) => {
    ...
    if (e.key === "ArrowRight") goNext(key);
    else goPrev(key);
  });
});
...
function onPlayerError(event) {
  ...
  console.warn(
    "[music player] YouTube error code",
    event.data,
    "on track",
    currentTrackIndex,
  ...
  if (titleEl)
    titleEl.innerHTML =
      '<i class="fa-solid fa-triangle-exclamation"></i> Unavailable, skipping...';
...
function renderNowPlaying() {
  ...
  const titleEl = document.getElementById("musicTrackTitle");
  if (titleEl)
    titleEl.textContent = hasUserStartedPlayback
...
function renderMusicPlaylist() {
  ...
  ul.querySelectorAll("li").forEach((li) => {
    li.addEventListener("click", () =>
      playTrack(parseInt(li.getAttribute("data-index"), 10), true),
    );
  });
}
