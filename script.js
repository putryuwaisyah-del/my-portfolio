...
const aboutStoryEN = [
    "Hi, I'm Puteri Uwaisyahtul Akashah, a fresh graduate in Mathematical Modelling and Analytics (Big Data) from Universiti Teknologi MARA (UiTM) Shah Alam. I'm passionate about data analytics, AI, and technology, with a curiosity for solving real-world problems and continuously expanding my skills. I enjoy transforming data into meaningful insights and building solutions that create real value.",
    "Throughout my academic journey and internship, I gained hands-on experience in Power BI, Excel, Google Sheets, HTML, CSS, JavaScript, MySQL, Python, dashboard development, system testing, and AI-assisted workflows. I actively leverage AI tools such as ChatGPT, Claude.ai, Google Gemini, NotebookLM, Bluedot.ai, and Figma AI to support research, data analysis, software testing, documentation, UI/UX design, presentation development, and knowledge management. I believe AI is most effective when combined with technical expertise and critical thinking, enabling me to work more efficiently, solve problems faster, and deliver high-quality results. " ,
    "Beyond my academic and technical pursuits, I enjoy connecting with people, volunteering, and contributing to community initiatives, as I believe personal growth comes from collaboration, continuous learning, and meaningful experiences. Outside of work, I stay active through badminton and nature exploration, and I also enjoy singing, watching K-dramas such as Moving, Study Group, and Wonderfools, as well as action movies. I am also an avid Mobile Legends player, where I reached Mythical Glory as a Kagura main. This experience has strengthened my teamwork, strategic thinking, adaptability, communication, and ability to stay calm under pressure. One small habit that reflects my personality is carrying mini packets of cat wet food in my bag so I can feed stray cats whenever I encounter them. At home, I am also a proud cat parent to two cats.", 
    "As a fresh graduate, I bring a unique combination of technical knowledge, analytical thinking, and a strong desire to create meaningful impact. Beyond my skills in data analytics, AI, and technology, I bring curiosity, adaptability, and a proactive mindset that allows me to approach challenges with creativity and purpose. I am passionate about transforming complex data into meaningful insights, developing innovative solutions, and leveraging technology to support data-driven decision-making. With a meticulous approach and a commitment to continuous learning, I strive to contribute valuable ideas, collaborate effectively with diverse teams, and grow alongside organisations that embrace innovation and positive change."
];

const aboutStoryMS = [
    "Hai, saya Puteri Uwaisyahtul Akashah, seorang graduan baharu dalam bidang Pemodelan Matematik dan Analitik (Data Raya) dari Universiti Teknologi MARA (UiTM) Shah Alam. Saya meminati analitik data, kecerdasan buatan (AI), dan teknologi, serta sentiasa ingin tahu dalam menyelesaikan masalah dunia sebenar sambil terus mengembangkan pengetahuan dan kemahiran saya. Saya gemar menukarkan data kepada maklumat yang bermakna dan membangunkan penyelesaian yang memberikan nilai serta impak sebenar.",
    "Sepanjang pengajian dan latihan industri, saya memperoleh pengalaman praktikal dalam Power BI, Microsoft Excel, Google Sheets, HTML, CSS, JavaScript, MySQL, Python, pembangunan papan pemuka (dashboard), ujian sistem, serta aliran kerja yang dibantu AI. Saya aktif memanfaatkan pelbagai alat AI seperti ChatGPT, Claude.ai, Google Gemini, NotebookLM, Bluedot.ai, dan Figma AI untuk menyokong penyelidikan, analisis data, ujian perisian, dokumentasi, reka bentuk UI/UX, penyediaan pembentangan, serta pengurusan pengetahuan. Saya percaya AI memberikan manfaat terbaik apabila digabungkan dengan kepakaran teknikal dan pemikiran kritis, membolehkan saya bekerja dengan lebih cekap, menyelesaikan masalah dengan lebih pantas, serta menghasilkan keputusan yang berkualiti tinggi.",
    "Di luar bidang akademik dan teknikal saya, saya gemar berhubung dengan orang lain, melakukan kerja sukarela, dan menyumbang kepada inisiatif komuniti kerana saya percaya bahawa pertumbuhan peribadi datang daripada kerjasama, pembelajaran berterusan, dan pengalaman yang bermakna. Di luar waktu kerja, saya aktif bermain badminton dan meneroka alam semula jadi, serta menikmati aktiviti menyanyi, menonton K-drama seperti Moving, Study Group, dan Wonderfools, serta filem aksi. Saya juga seorang pemain Mobile Legends yang aktif, di mana saya telah mencapai tahap Mythical Glory sebagai pemain utama Kagura. Pengalaman ini telah mengukuhkan kemahiran kerja berpasukan, pemikiran strategik, kebolehsuaian, komunikasi, dan keupayaan untuk kekal tenang di bawah tekanan. Satu tabiat kecil yang mencerminkan personaliti saya ialah saya sentiasa membawa paket kecil makanan kucing basah di dalam beg supaya saya dapat memberi makan kucing jalanan apabila saya berjumpa dengan mereka, dan di rumah saya juga merupakan seorang pemilik bangga kepada dua ekor kucing.",
    "Sebagai graduan baharu, saya membawa gabungan unik antara pengetahuan teknikal, pemikiran analitikal, dan keinginan yang tinggi untuk menghasilkan impak yang bermakna. Selain kemahiran dalam analitik data, AI, dan teknologi, saya turut membawa sifat ingin tahu, kebolehsuaian, serta sikap proaktif yang membolehkan saya menghadapi cabaran dengan kreativiti dan tujuan yang jelas. Saya berminat dalam mentransformasikan data yang kompleks kepada pandangan bermakna, membangunkan penyelesaian inovatif, dan memanfaatkan teknologi untuk menyokong pembuatan keputusan berasaskan data. Dengan pendekatan kerja yang teliti serta komitmen terhadap pembelajaran berterusan, saya berusaha untuk menyumbang idea bernilai, bekerjasama secara berkesan dalam pasukan yang pelbagai, dan berkembang bersama organisasi yang mengutamakan inovasi serta perubahan positif."
];

const aboutStoryJA = [
    "こんにちは。プテリ・ウワイシャトゥル・アカシャです。マラ工科大学（UiTM）シャー・アラム校で数理モデリング・アナリティクス（ビッグデータ）を専攻し、卒業しました。私はデータ分析、AI、テクノロジーに情熱を持ち、現実社会の課題を解決することや、新しい知識やスキルを継続的に学ぶことに強い関心があります。データを価値あるインサイトへと変え、実際に役立つソリューションを生み出すことにやりがいを感じています。",
    "大学生活およびインターンシップを通じて、Power BI、Microsoft Excel、Google Sheets、HTML、CSS、JavaScript、MySQL、Python、ダッシュボード開発、システムテスト、そしてAIを活用した業務フローに関する実践的な経験を積みました。また、ChatGPT、Claude.ai、Google Gemini、NotebookLM、Bluedot.ai、Figma AIなどのAIツールを積極的に活用し、リサーチ、データ分析、ソフトウェアテスト、ドキュメント作成、UI/UXデザイン、プレゼンテーション作成、ナレッジマネジメントを支援しています。私は、AIは技術力とクリティカルシンキングを組み合わせることで最大限の効果を発揮すると考えており、それによってより効率的に働き、課題を迅速に解決し、高品質な成果を生み出すことを目指しています。います。Claude.ai、NotebookLM、Bluedot.ai、ChatGPT、Google Gemini、Figma AIなどを使い、リサーチ、データ分析、ソフトウェアテスト、ドキュメント作成、UI/UXデザイン、プレゼン準備、ナレッジ管理をサポートしてきました。AIと専門知識を組み合わせることで、より賢く働き、質の高い成果を生み出すことを目指しています。",
    "私の学業および技術分野以外では、人とつながることやボランティア活動、地域社会への貢献を楽しんでいます。これは、個人の成長は協力、継続的な学び、そして意味のある経験から生まれると信じているためです。仕事以外では、バドミントンや自然散策を楽しみ、また歌うことや、Kドラマ（『Moving』『Study Group』『Wonderfools』など）やアクション映画を観ることも好きです。私はMobile Legendsの熱心なプレイヤーでもあり、KaguraメインとしてMythical Gloryランクに到達しました。この経験を通じて、チームワーク、戦略的思考、適応力、コミュニケーション能力、そしてプレッシャーの中でも冷静さを保つ力を身につけました。また、私の性格を表す小さな習慣として、野良猫に出会ったときにすぐ餌をあげられるように、カバンに猫用ウェットフードを常に持ち歩いており、家では2匹の猫を飼っています。",
    "新卒者として、私は技術的な知識、分析的思考力、そして有意義な価値を生み出したいという強い意欲を兼ね備えています。データ分析、AI、テクノロジーに関するスキルだけでなく、好奇心、適応力、主体的に行動する姿勢を活かし、創造性と明確な目的を持って課題に取り組むことができます。複雑なデータから価値ある洞察を導き出し、革新的なソリューションを開発するとともに、データに基づく意思決定を支援するためにテクノロジーを活用することに情熱を持っています。細部まで注意を払う姿勢と継続的に学び続ける意欲を大切にしながら、価値あるアイデアを提供し、多様なチームと効果的に協力し、イノベーションと前向きな変化を重視する組織とともに成長していきたいと考えています。"
];
...
const translations = {
    en: {
        ...
        ach5: "Led 25 committee members organizing futsal & netball tournaments with 100+ participants",
        ...
        exp4_title: "Mathematics & Science Tutor", exp4_sub: "Tuisyen Mesra PPR Lembah Subang 2",
    ...
    ms: {
        ...
        ach5: "Mengetuai 25 ahli jawatankuasa menganjurkan kejohanan futsal & bola jaring dengan 100+ peserta",
        ...
        exp4_title: "Tutor Matematik & Sains", exp4_sub: "Tuisyen Mesra PPR Lembah Subang 2",
    ...
    ja: {
        ...
        ach5: "25名の委員会メンバーを率い、100名以上が参加するフットサル・ネットボール大会を主催",
        ...
        exp4_title: "数学・理科チューター", exp4_sub: "Tuisyen Mesra PPR Lembah Subang 2",
